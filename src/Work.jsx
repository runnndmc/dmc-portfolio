    ...
    return(
        <div className='work'>  
            ...
            <div className='description-1'>
                ...
                <div className='built-with'>
                        <img className='dev-icon' src="https://img.icons8.com/color/48/000000/mongodb.png"/>
                        <img className='dev-icon' src="https://img.icons8.com/color/48/000000/nodejs.png"/>
                        <img className='dev-icon' src="https://img.icons8.com/color/48/000000/react-native.png"/>
                </div>
            ...
            <div className='description-2'>
                ...
                <div className='built-with'>
                        <img className='dev-icon' src="https://img.icons8.com/color/48/000000/react-native.png"/>
                        <img className='dev-icon' src="https://img.icons8.com/color/48/000000/css3.png"/>   
                </div>
                <div className='text'>
